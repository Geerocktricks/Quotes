...
"resource": {
  ...
  "rules":[
    ...
    [["if",4],["add",16,18,24,30,32,38,42,50,9,8,10,66]],
    [["if",5],["add",21,53,63]],
    [["if",6],["add",25,57]],
    [["if",3,8],["add",40,43,60]],
    [["if",9],["add",48,8]],
...
Z.a.f=["google"],function(){(function(a){Z.__f=a;Z.__f.g="f";Z.__f.h=!0;Z.__f.b=0})(function(a){var b=U("gtm.referrer",1)||B.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?$g(N(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):wb(N(String(b))):String(b)})}();Z.a.k=["google"],function(){(function(a){Z.__k=a;Z.__k.g="k";Z.__k.h=!0;Z.__k.b=0})(function(a){return ch(a.vtp_name,U("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
a.vtp_visitorEmail);z.__adroll_loaded=!0;var c=X("https://s","http://a",".adroll.com/j/roundtrip.js");S(c,a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)})}();
...
b&&void 0!==b.content_ids&&(b.content_ids=JSON.parse(b.content_ids.replace(/'/g,'"')));window.twq("track",String(a.vtp_event_type),b);I(a.vtp_gtmOnSuccess)})}();
